...
<html>
	...
	<body>
    	<ul class="nav nav-tabs sys-font">
			<li class="active"><a href="${ctx }/sys/ywymUserWebController/list">终端列表</a></li>
		...
		<form action="${ctx }/sys/ywymUserWebController/inputExcel?status=2"  method="post" enctype="multipart/form-data" style="float: left; margin-left: 30px; margin-top: -4px;">
	...
	<script type="text/javascript">
		...
		function allUserList(page){
			...
			$.ajax({
				url:"${ctx}/sys/ywymUserWebController/getUserList?page="+page+"&type=1",
				type:"post",
				data: formData,  
	            cache: false,  
	            contentType: false,  
