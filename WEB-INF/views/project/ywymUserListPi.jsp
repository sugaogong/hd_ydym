...
<html>
	...
	<body>
    	<ul class="nav nav-tabs sys-font">
			<li class="active"><a href="${ctx }/sys/ywymUserWebController/listPi">批发商列表</a></li>
			<%-- <li><a href="${ctx }/sys/ywymUserWebController/formAdmin">批发商添加</a></li> --%>
		</ul>
		...
		<form action="${ctx }/sys/ywymUserWebController/inputExcel?status=1"  method="post" enctype="multipart/form-data" style="float: left; margin-left: 30px; margin-top: -4px;">
	...
	<script type="text/javascript">
		...
		function allUserList(page){
			...
			$.ajax({
				url:"${ctx}/sys/ywymUserWebController/getUserList?page="+page+"&type=3",
				type:"post",
				data: formData,  
	            cache: false,  
	            contentType: false,  
