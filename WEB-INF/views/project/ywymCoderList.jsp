...
<html>
	...
	<body>
    	<ul class="nav nav-tabs sys-font">
			...
			<li class="active"><a href="${ctx }/sys/ywymCoderWebController/list">下级卡券修改</a></li>
		</ul>
		<form:form id="searchForm" modelAttribute="ywymCoder" action="${ctx }/sys/ywymCoderWebController/list" method="post" class="breadcrumb form-search">
			<ul class="ul-form">
				<li><label>用户名称：</label>
		...
		<c:forEach items="${page.list}" var="entity">
			<tr>
				...
				<td>
    				<a href="${ctx }/sys/ywymCoderWebController/formUpdate?id=${entity.id }">修改</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
